...
switch MTGP_case
    case 1
        ...
        opt.se_hyp = 1;                 % initial value for lenght scale hyperparameter
    case 2
        opt.cov_func = 2;               % select cov. function
        opt.se_hyp = [1 0.5 0.05];      % initial value for lenght scale hyperparameter
                                        % 3 squared exponential hyperpara. for 3
                                        % tasks
%         opt.se_hyp = [1 1 1];      % initial value for lenght scale hyperparameter
    otherwise
